CLASS zcl_aar_abapgit_res_repo_push DEFINITION
  PUBLIC
...
CLASS zcl_aar_abapgit_res_repo_push IMPLEMENTATION.
  ...
  METHOD post.
    ...
    TRY.
        ...
        " get push action instance
        DATA(lo_bg_action) =
          zcl_abapgit_action_factory=>get_action_instance( iv_repo_key = lv_repo_key
        ...
        " initialize push
        lo_bg_action->initialize( ).

        lo_bg_action->execute( ).
